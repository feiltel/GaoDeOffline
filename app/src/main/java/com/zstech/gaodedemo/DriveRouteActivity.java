...
import com.zstech.gaodedemo.util.AMapUtil;
import com.zstech.gaodedemo.util.ToastUtil;

public class DriveRouteActivity extends AppCompatActivity implements AMap.OnMapClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dirve_route);
